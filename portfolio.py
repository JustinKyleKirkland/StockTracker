...
class Portfolio:
            ...
            try:
                ...
                if not stock_df.empty:
                    ...
                    if data['purchase_price'] is not None:
                        gain_loss = current_value - (data['purchase_price'] * data['shares'])
                        gain_loss_percent = (current_price / data['purchase_price'] - 1) * 100
    ...
    def get_portfolio_summary(self):
        ...
        total_cost = sum(
            stock['purchase_price'] * stock['shares'] 
            ...
            for symbol, transactions in data.items():
                ...
                for transaction in transactions:
                    ...
                    if action.lower() == "bought":
                        ...
                        total_shares -= float(shares)
                        # For simplicity, we don't adjust cost basis when selling
    ...
    def get_performance_metrics(self):
        ...
        for symbol in self.transactions:
            ...
            gain_loss_pct = (gain_loss / initial_investment * 100) if initial_investment > 0 else 0
            ...
            if earliest_date:
                ...
                if days_held > 0:
                    annual_return = ((1 + gain_loss_pct/100) ** (365/days_held) - 1) * 100 if days_held > 0 else 0
                    time_based_metrics = {
                        'days_held': days_held,
        ...
        metrics['total_gain_loss'] = metrics['total_current_value'] - metrics['total_invested']
        metrics['total_gain_loss_pct'] = (metrics['total_gain_loss'] / metrics['total_invested'] * 100) if metrics['total_invested'] > 0 else 0
