...
app = dash.Dash(
    ...
    external_scripts=[{"src": "/assets/enhanced_charts.js"}],
)
                        ...
                        html.Div(
                            [
                                html.Div(
                                    [
                                        html.H3(
                                            "Stock Symbol", className="card-header"
                                        ),
                                        html.Div(
                                            [
                                                dcc.Input(
                                ...
                                html.Div(
                                    [
                                        html.H3(
                                            "Latest News", className="section-header"
                                        ),
                                        dcc.Loading(
                                            id="loading-news",
                                            type="circle",
                    ...
                    children=[
                        html.Div(
                            [
                                ...
                                dcc.Interval(
                                    id="portfolio-auto-update-interval",
                                ...
                                html.Div(
                                    [
                                        html.H3(
                                            "Import Portfolio", className="card-header"
                                        ),
                                        html.Div(
                                            [
                                                dcc.Dropdown(
                                ...
                                html.Div(
                                    [
                                        html.H3(
                                            "Portfolio Summary", className="card-header"
                                        ),
                                        html.Div(
                                    ...
                                    [
                                        html.Div(
                                            [
                                                ...
                                                html.Div(
                                                    id="portfolio-last-update",
                                                    className="last-update-timestamp",
                                                ),
                                            ],
                                            className="card-header-with-timestamp",
                                        ),
                                    ...
                                    [
                                        html.Div(
                                            [
                                                ...
                                                html.Div(
                                                    id="transaction-history-last-update",
                                                    className="last-update-timestamp",
                                                ),
                                            ],
                                            className="card-header-with-timestamp",
                                ...
                                html.Div(
                                    [
                                        ...
                                        dcc.Loading(
                                            id="loading-portfolio-correlation-heatmap",
                                            type="circle",
                                            children=[
                                                dcc.Graph(
                                                    id="portfolio-correlation-heatmap"
                                                ),
                                            ],
                                        ),
                                    ],
                        ...
                        html.Div(
                            [
                                html.Div(
                                    [
                                        html.H3(
                                            "Compare Stocks", className="card-header"
                                        ),
                                        html.Div(
                                            [
                                                dcc.Input(
                                ...
                                html.Div(
                                    [
                                        html.H3(
                                            "Price Comparison", className="card-header"
                                        ),
                                        html.Div(
                                            [
                                ...
                                html.Div(
                                    [
                                        ...
                                        html.Div(
                                            [
                                                dcc.Graph(
                                                    id="comparison-correlation-heatmap"
                                                ),
                                            ],
                                            className="graph-container",
                                        ),
                    ...
                    children=[
                        html.Div(
                            [
                                # Hidden interval component for auto-updates
                                dcc.Interval(
                                    id="profit-auto-update-interval",
                                    interval=60000,  # in milliseconds (60 seconds)
                                    n_intervals=0,
                                ),
                                ...
                                html.Div(
                                    [
                                        html.H3(
                                            "Profit Overview", className="card-header"
                                        ),
                                        html.Div(
                                            id="profit-overview-cards",
                                            className="profit-overview-cards",
                                        ),
                                    ],
                                    className="card",
                                ),
                                ...
                                html.Div(
                                    [
                                        html.H3(
                                            "Profit Breakdown", className="card-header"
                                        ),
                                        dcc.Tabs(
                                            id="profit-breakdown-tabs",
                                            value="tab-combined",
                                            ...
                                            children=[
                                                ...
                                                dcc.Tab(
                                                    ...
                                                    value="tab-unrealized",
                                                    className="inner-tab",
                                                ),
                                            ],
                                        ),
                                        html.Div(
                                            id="profit-breakdown-content",
                                            className="profit-breakdown-content",
                                        ),
                                    ],
                                    className="card",
                                ),
                                ...
                                html.Div(
                                    [
                                        ...
                                        dcc.Tabs(
                                            id="profit-chart-tabs",
                                            value="chart-breakdown",
                                            className="inner-tabs",
                                            children=[
                                                dcc.Tab(
...
def update_stock_graph(n_clicks, period, chart_type, stock_symbol):
    ...
    try:
        ...
        if not df.empty:
            ...
            price_change_pct = (
                (price_change / prev_price) * 100 if prev_price != 0 else 0
            )
...
@app.callback(
    [Output("portfolio-table", "children"), Output("portfolio-graph", "figure")],
            ...
            row = html.Tr(
                [
                    ...
                    html.Td(
                        ...
                        className="positive-value"
                        if stock.get("gain_loss", 0) >= 0
                        else "negative-value",
                    ),
                    html.Td(
                        f"{stock['gain_loss_percent']:.2f}%"
                        if stock["purchase_price"]
                        else "N/A",
                        className="positive-value"
                        if stock.get("gain_loss_percent", 0) >= 0
                        else "negative-value",
                    ),
                    html.Td(
                        html.Button(
                            "Remove",
                            id={"type": "remove-stock", "index": stock["symbol"]},
                        )
                    ),
                ]
            )
    ...
    if button_id:
        try:
            ...
            if portfolio_data:
                ...
                table_body = [html.Tbody(rows)]
                table = html.Table(
                    table_header + table_body, className="portfolio-table"
                )
        ...
        if success:
            ...
            if portfolio_data:
                ...
                for stock in portfolio_data:
                    ...
                    # Use the gain_loss and gain_loss_percent directly from the portfolio_data
                    # which is calculated correctly based on the remaining cost
                    gain_loss = stock.get(
                        "gain_loss", current_value - (shares * purchase_price)
                    )
                    gain_loss_pct = stock.get(
                        "gain_loss_percent",
                        (gain_loss / (shares * purchase_price)) * 100
                        if purchase_price
                        else 0,
                    )
                    ...
                    gain_loss_class = (
                        "positive-value" if gain_loss >= 0 else "negative-value"
                    )
                ...
                total_realized_profit = metrics.get("total_realized_profit", 0)
                            ...
                            [
                                ...
                                html.Div(
                                    [
                                        ...
                                        html.Div(
                                            f"${(total_gain_loss + total_realized_profit):.2f}",
                                            className="positive-value"
                                            if (total_gain_loss + total_realized_profit)
                                            >= 0
                                            else "negative-value",
                                        ),
                                    ],
                ...
                return (
                    html.Div(
                        f"Successfully imported portfolio from {os.path.basename(file_path)}",
            ...
            return (
                html.Div(
                    "Portfolio imported but no stocks found",
                    className="warning-message",
                ),
                html.P("No stocks in portfolio yet."),
                {},
                no_update,
            )
        else:
            return (
                html.Div("Failed to import portfolio", className="error-message"),
                no_update,
                no_update,
                no_update,
            )
...
def update_graph(n_clicks, stock_symbol, time_period, chart_type):
    ...
    try:
        ...
        if current_price != "N/A":
            ...
            price_change_pct = (
                (price_change / df["Close"][-2] * 100) if len(df) >= 2 else 0
            )
                    ...
                    [
                        ...
                        html.Div(
                            [
                                ...
                                html.Span(
                                    f" {price_icon} {price_change_pct:.2f}%",
        ...
        if market_cap != "N/A" and isinstance(market_cap, (int, float)):
            market_cap_str = (
                f"${market_cap / 1000000000:.2f}B"
                if market_cap >= 1000000000
                else f"${market_cap / 1000000:.2f}M"
            )
            kpi_cards.append(
                html.Div(
                    [
        ...
        if div_yield not in ("N/A", None):
            div_yield_pct = (
                div_yield * 100 if isinstance(div_yield, (int, float)) else div_yield
            )
            kpi_cards.append(
                html.Div(
                    [
                    ...
                    [
                        html.Div(
                            [
                                ...
                                else html.Div(className="news-thumbnail-placeholder"),
                                html.Div(
                                    [
                                        html.H4(
                                            item.get("title"), className="news-title"
                                        ),
                                        html.Div(
                                            [
                                                html.Span(
                                                    item.get("publisher"),
                                                    className="news-publisher",
                                                ),
                                                html.Span(" • "),
                                                html.Span(
                                                    item.get("published"),
        ...
        news_container = html.Div(
            news_cards
            if news_cards
            else html.Div("No recent news found", className="no-news")
        )
...
# Callback to update portfolio correlation heatmap
@app.callback(
    Output("portfolio-correlation-heatmap", "figure"),
    [
        Input("tabs", "value"),
        Input("portfolio-auto-update-interval", "n_intervals"),
        Input("import-portfolio-button", "n_clicks"),
        Input("add-stock-button", "n_clicks"),
        Input({"type": "remove-stock", "index": ALL}, "n_clicks"),
    ],
...
def update_portfolio_correlation_heatmap(
    tab_value, n_intervals, import_clicks, add_clicks, remove_clicks
):
    """Update the portfolio correlation heatmap whenever the portfolio changes"""
    if not portfolio.stocks or len(portfolio.stocks) < 2:
        # Return empty figure with message if not enough stocks for correlation
        return {
            "data": [],
            "layout": go.Layout(
                title="Need at least 2 stocks for correlation analysis",
                height=400,
                xaxis={"visible": False},
                yaxis={"visible": False},
            ),
    ...
    try:
        ...
        if historical_data.empty or len(historical_data.columns) < 2:
            return {
                "data": [],
                "layout": go.Layout(
                    title="Insufficient data for correlation analysis", height=400
                ),
            }

        # Calculate correlation matrix
        correlation_matrix = historical_data.pct_change().corr(method="pearson")
        ...
        heatmap = go.Heatmap(
            ...
            x=correlation_matrix.columns,
            y=correlation_matrix.index,
            colorscale="RdBu_r",  # Red to Blue, reversed
        ...
        layout = go.Layout(
            ...
            height=400,
            xaxis=dict(title="", tickangle=-45, side="bottom", tickfont=dict(size=10)),
            yaxis=dict(title="", tickangle=0, side="left", tickfont=dict(size=10)),
        ...
        print(f"Error generating portfolio correlation heatmap: {str(e)}")
        return {
            "data": [],
            "layout": go.Layout(
                title="Error: Could not generate correlation heatmap", height=400
            ),
        }
